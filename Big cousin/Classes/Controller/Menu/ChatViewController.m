...
//    self.tabBarController.tabBar.hidden=YES;
    ...
    imageV.image=[UIImage imageNamed:@"4444.jpg"];
    ...
    EMError *error = [[EMClient sharedClient] loginWithUsername:@"wuhan107" password:@"qwer123"];
    NSLog(@"%@",error);
    
    //创建一个和某人的单聊会话
    EMConversation *conversion=[[EMClient sharedClient].chatManager getConversation:@"wuhan108" type:EMConversationTypeChat createIfNotExist:YES];
